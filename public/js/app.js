...
!function () {
  ...
  if (q.autoFetchSvg && !q.fetchSvgFrom && b && b.currentScript) {
    ...
    -1 < G.search(W) && (E || console.info("Font Awesome SVG Auto-fetching URL has been determined using document.currentScript. This features is not supported in any version of Internet Explorer. ".concat(X)), q.fetchSvgFrom = G.replace(W, "/svgs"));
  }
  ...
  var at,
      ...
      ct = "rejected",
      st = function st() {},
      lt = "undefined" != typeof __webpack_require__.g && void 0 !== __webpack_require__.g.process && "function" == typeof __webpack_require__.g.process.emit,
  ...
  function xt(t) {
    t._state = ct, yt(t), !t._handled && lt && __webpack_require__.g.process.emit("unhandledRejection", t._data, t);
  }
  ...
  var Yt = function Yt() {},
    ...
    begin: function begin(t) {
      return Dt.mark("".concat(Vt, " ").concat(t, " begins")), function () {
        return qt(t);
      };
    },
    end: qt
  },
      Xt = function Xt(t, e, n, a) {
    var r,
        i,
        o,
        c,
  ...
  function re(t, e, n) {
    var a,
        ...
        c,
        s,
        l = (i = r = null, o = (a = n).match(Jt), c = a.match(Qt), (s = a.match(Zt)) ? i = [s[1], s[2]] : c && (i = c[1]), o && i && (r = [parseInt(o[1], 10), parseInt(o[2], 10), [], null, i]), r);
    l && !Kt(e) && (Bt(t, u({}, e, l), {
      skipHooks: !0
  ...
  var ce = function ce(r, i) {
    ...
    return ie[r] && ie[r][i] || (ie[r] = $({}, ie[r] || {}, u({}, i, []))), new St(function (e, t) {
      ...
      if (ie[r][i].push(function (t) {
        e(t);
      }), 1 === ie[r][i].length) if ("function" == typeof fetch) fetch(n, {
        mode: "cors"
      }).then(function (t) {
        return t.text();
      }).then(function (t) {
  ...
  function de(t) {
    return t.reduce(function (t, e) {
      ...
      if (fe[e]) t.prefix = e;else if (et.autoFetchSvg && -1 < Object.keys(z).indexOf(e)) t.prefix = e;else if (n) {
    ...
    if (l && et.observeMutations) {
      ...
      ke = new l(function (t) {
        we || Et(t).forEach(function (t) {
          if ("childList" === t.type && 0 < t.addedNodes.length && !ge(t.addedNodes[0]) && (et.searchPseudoElements && o(t.target), r(t.target)), "attributes" === t.type && t.target.parentNode && et.searchPseudoElements && o(t.target.parentNode), "attributes" === t.type && ge(t.target) && ~_.indexOf(t.attributeName)) if ("class" === t.attributeName) {
    ...
    return new St(function (a, t) {
      ...
      if (r && "none" !== o && "" !== o) {
        var c = n.getPropertyValue("content"),
            ...
            f = le(s, l),
            u = f;
        if (u || (u = l), f || (f = String.fromCharCode(parseInt(l, 16))), !f || e && e.getAttribute(C) === s && e.getAttribute(O) === u) a();else {
...
/* harmony import */ var _font_js_pro_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../font/js/pro.min */ "./resources/font/js/pro.min.js");
/* harmony import */ var _font_js_pro_min__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_font_js_pro_min__WEBPACK_IMPORTED_MODULE_0__);
...
/******/ 	__webpack_require__.O(undefined, ["css/frontend","css/app"], () => (__webpack_require__("./resources/sass/frontend.scss")))
