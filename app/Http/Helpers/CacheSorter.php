...
class CacheSorter
{
    ...
    public function worldometer_continent_sort($data,$filter_data)
    {
        ...
        $response = array(
            ...
            'timeline' => array(
                'today' => array(
                    'cases'         => isset($data['timeline']['today']['cases']) ? $data['timeline']['today']['cases'] : 0,
                    'todayCases'    => isset($data['timeline']['today']['todayCases']) ? $data['timeline']['today']['todayCases'] : 0,
                    'deaths'        => isset($data['timeline']['today']['deaths']) ? $data['timeline']['today']['deaths'] : 0,
                    'todayDeaths'   => isset($data['timeline']['today']['todayDeaths']) ? $data['timeline']['today']['todayDeaths'] : 0,
                    'recovered'     => isset($data['timeline']['today']['recovered']) ? $data['timeline']['today']['recovered'] : 0,
                    'todayRecovered'=> isset($data['timeline']['today']['todayRecovered']) ? $data['timeline']['today']['todayRecovered'] : 0,
                    'active'        => isset($data['timeline']['today']['active']) ? $data['timeline']['today']['active'] : 0,
                    'critical'      => isset($data['timeline']['today']['critical']) ? $data['timeline']['today']['critical'] : 0,
                ),
                'yesterday' => array(
                    'cases'         => isset($data['timeline']['yesterday']['cases']) ? $data['timeline']['yesterday']['cases'] : 0,
                    'todayCases'    => isset($data['timeline']['yesterday']['todayCases']) ? $data['timeline']['yesterday']['todayCases'] : 0,
                    'deaths'        => isset($data['timeline']['yesterday']['deaths']) ? $data['timeline']['yesterday']['deaths'] : 0,
                    'todayDeaths'   => isset($data['timeline']['yesterday']['todayDeaths']) ? $data['timeline']['yesterday']['todayDeaths'] : 0,
                    'recovered'     => isset($data['timeline']['yesterday']['recovered']) ? $data['timeline']['yesterday']['recovered'] : 0,
                    'todayRecovered'=> isset($data['timeline']['yesterday']['todayRecovered']) ? $data['timeline']['yesterday']['todayRecovered'] : 0,
                    'active'        => isset($data['timeline']['yesterday']['active']) ? $data['timeline']['yesterday']['active'] : 0,
                    'critical'      => isset($data['timeline']['yesterday']['critical']) ? $data['timeline']['yesterday']['critical'] : 0,
                ),
                'yesterday2' => array(
                    'cases'         => isset($data['timeline']['yesterday2']['cases']) ? $data['timeline']['yesterday2']['cases'] : 0,
                    'todayCases'    => isset($data['timeline']['yesterday2']['todayCases']) ? $data['timeline']['yesterday2']['todayCases'] : 0,
                    'deaths'        => isset($data['timeline']['yesterday2']['deaths']) ? $data['timeline']['yesterday2']['deaths'] : 0,
                    'todayDeaths'   => isset($data['timeline']['yesterday2']['todayDeaths']) ? $data['timeline']['yesterday2']['todayDeaths'] : 0,
                    'recovered'     => isset($data['timeline']['yesterday2']['recovered']) ? $data['timeline']['yesterday2']['recovered'] : 0,
                    'todayRecovered'=> isset($data['timeline']['yesterday2']['todayRecovered']) ? $data['timeline']['yesterday2']['todayRecovered'] : 0,
                    'active'        => isset($data['timeline']['yesterday2']['active']) ? $data['timeline']['yesterday2']['active'] : 0,
                    'critical'      => isset($data['timeline']['yesterday2']['critical']) ? $data['timeline']['yesterday2']['critical'] : 0,
                ),
            ),
        );
        return $response;
