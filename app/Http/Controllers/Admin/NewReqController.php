...
class NewReqController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = NewReq::query()->select(sprintf('%s.*', (new NewReq())->table));
            ...
            $table->editColumn('catogary', function ($row) {
                return $row->catogary ? $row->catogary : '';
            });
        ...
        return view('admin.newReqs.index');
    }
    ...
    public function create()
    {
        ...
        return view('admin.newReqs.create');
    }
    ...
    public function edit(NewReq $newReq)
    {
        ...
        return view('admin.newReqs.edit', compact('newReq'));
    }
