    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.countries.update", [$country->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('slug') ? 'is-invalid' : '' }}" type="text" name="slug" id="slug" value="{{ old('slug', $country->slug) }}" required>
                @if($errors->has('slug'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('region') ? 'is-invalid' : '' }}" type="text" name="region" id="region" value="{{ old('region', $country->region) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subregion') ? 'is-invalid' : '' }}" type="text" name="subregion" id="subregion" value="{{ old('subregion', $country->subregion) }}" required>
